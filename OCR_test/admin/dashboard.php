...
$regusers = mysqli_num_rows($results);
?>
...
$results1 = mysqli_query( $dbh , $sql1 );

$totalvehicle = mysqli_num_rows($results1);//$query1->rowCount();
?>
...
$results2 = mysqli_query( $dbh , $sql2 );

$bookings = mysqli_num_rows($results2);
...
$brands = mysqli_num_rows($results3);
...
$results4 = mysqli_query( $dbh , $sql4 );

$subscribers = mysqli_num_rows($results4);
...
$results6 = mysqli_query( $dbh , $sql6 );

$query = mysqli_num_rows($results6);
...
$results5 = mysqli_query( $dbh , $sql5 );

$testimonials = mysqli_num_rows($results5);
